...
<section class="form-container">
   ...
   <form action="" method="post">
      <h3>Alamat</h3>
      <input type="text" class="box" placeholder="Nama Jalan,Gedung,No.Rumah" required maxlength="70" name="area">
      <input type="text" class="box" placeholder="Blok/Unit No.Patokan" required maxlength="70" name="building">
      <input type="text" class="box" placeholder="Provinsi" required maxlength="50" name="town">
